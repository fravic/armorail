package septenary.duelparty.screens {
    ...
    public class TurnOrderSelectionScreen extends Screen {
        ...
        public function TurnOrderSelectionScreen(players:Array) {
            super();
            _alwaysOnTop = true;
        ...
        protected function playerTurnOrderRoll(playerNum:int):void {
            ...
            var diceRoll:DiceRollScreen = new DiceRollScreen(_players[playerNum]);
        ...
        protected function endTurnOrderRoll(e:GameEvent):void {
            ...
            for (var i:int = 0; i < _diceRolls.length; i++) {
                (_diceRolls[i] as DiceRollScreen).restrictRollNumbers([e.data.roll]);
            }
