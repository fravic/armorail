package septenary.duelparty.screens {
    ...
    public class MapBuilderScreen extends Screen {
        ...
        protected function showMapBuilderMenu():void {
            var tileSelect:MapBuilderMenuScreen = new MapBuilderMenuScreen();
        ...
        protected function mapBuilderMenuAction(e:GameEvent):void {
            ...
            switch(e.data.action) {
                case MapBuilderMenuScreen.ACTION_ADD_TILE:
                    addNewTile(e);
                    break;
                case MapBuilderMenuScreen.ACTION_COMPILE_MAP:
                    compileMap();
                    break;
                case MapBuilderMenuScreen.ACTION_LOAD_MAP:
                    loadMap();
                    break;
                case MapBuilderMenuScreen.ACTION_LOAD_BG:
                    loadBackground();
                    break;
                case MapBuilderMenuScreen.ACTION_TILE_PARAMS:
                    setSelectedTileParams();
                    break;
                case MapBuilderMenuScreen.ACTION_ADD_EMB:
                    addNewEmb(e);
                    break;
            }
        }
        ...
        protected function checkErrorCasesOnTile(tile:BoardTile):Boolean {
            ...
            if (!tile.tilesOut.length) {
                showDialogBox(DialogScreen.DIALOG_ONLY, {speaker:"Map Builder",
        ...
        protected function loadMap():void {
            showDialogBox(DialogScreen.TEXT_INPUT, {speaker:"Map Builder",
        ...
        protected function setSelectedTileParams():void {
            if (!_selectedTile) {
                ...
                if (tileClass.getParamFields == null) {
                    ...
                    showDialogBox(DialogScreen.DATA_GRID, {speaker:"Map Builder",
